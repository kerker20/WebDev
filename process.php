...
if (isset($_POST['submit'])) {
    ...
    $mysqli->query("Insert into teacherinfo (name,subjects,type,address,contact,payment,status,obtain) values('$username','$subjects','$type','$address','$contact','$payment',1,'no')") or die($mysqli->error);
...
if (isset($_GET['accept'])) {
    ...
    mysqli_query($mysqli, "update request set obtain= 'yes' where name='$student' && teacher='" . $_SESSION['name'] . "'") or die($mysqli->error);
