                ...
                <ul class="cd-side__list js-cd-side__list">
                    ...
                    <li class="cd-side__item cd-side__item--has-children cd-side__item--users js-cd-item--has-children">
                        ...
                        <ul class="cd-side__sub-list">
                            ...
                            <li class="cd-side__sub-item"><a href="detailsstudent.php">Students</a></li>
                        </ul>
                    </li>
                </ul>
            ...
            <div class="cd-content-wrapper">
                ...
                <div class="app-main__outer" id="one">
                    <div class="app-main__inner">
                                            ...
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_array($result)) : ?>
                                                    <tr>
                                                        ...
                                                        <td><small><?php echo $row['rpass'] ?></small></td>
                                                        <td>
                                                            <?php if ($row['status'] == 1) : ?>
                        ...
                        <br>
                        <a href="detailsstudent.php" class="btn" id="details"><small>Show more details</small> &nbsp;<i class="far fa-eye"></i></a>
